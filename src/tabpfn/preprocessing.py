...
class ProcessedDataset:
    ...
    generated by the `DatasetCollectionWithPreprocessing.__getitem__` method,
    ensuring a consistent return type for both classification and regression
    tasks.
    ...
    Attributes:
        ...
        y_test_raw (Optional[torch.Tensor]): Original, unprocessed test
            target tensor. Only available for regression tasks.
        normalized_bardist (Optional[FullSupportBarDistribution]): Binning
            distribution for the *standardized* target variable. Only
            available for regression tasks.
        bardist (Optional[FullSupportBarDistribution]): Binning
            distribution for the *raw* target variable. Only available
    ...
    bardist: FullSupportBarDistribution | None = None
