    ...
    def __init__(
        ...
        *,
        ...
        message = (
            ...
            f"    batch_size = 1000  # adjust for your hardware\n"
            f"    predictions = []\n"
            ...
            f"If even batch_size=1 causes OOMs, your training set is too large — "
            f"TabPFN's attention mechanism scales quadratically with the number "
            f"of training + test samples, so large training sets can exceed memory "
            f"on their own. In that case, see the large-dataset guide for "
