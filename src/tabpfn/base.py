...
from tabpfn.preprocessing.modality_detection import handle_datetime_columns
...
def get_embeddings(
    ...
    handle_datetime_columns(X, categorical_indices=model.categorical_features_indices)
