...
- Fixed import error due to old HuggingFace dependency

## [6.0.2] - 2025-11-06

### Changed

- Add informative message when not authorised for TabPFN-2.5 model repo [#610](https://github.com/PriorLabs/TabPFN/pull/610)
