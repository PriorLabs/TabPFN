...
The code in this repository is licensed under the [Apache License 2.0](LICENSE). Third-party code retains its own licenses and attribution; see [Third-Party Notices](THIRD-PARTY-NOTICES.md).

Model weights are licensed separately and are not covered by this code license change.
